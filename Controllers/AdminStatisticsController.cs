   ...
   public IActionResult Dashboard()
{
    return View("~/Views/Admin/Index.cshtml");
        ...
        {
            var postCount = await _context.Posts.CountAsync(p => p.Status == "Chờ duyệt");
        ...
        {
            var postCount = await _context.Posts.CountAsync(p => p.Status == "Đã duyệt" || p.Status == "Không duyệt");
